...
builder.Services.Configure<DynamoDbSettings>(builder.Configuration.GetSection(DynamoDbSettings.Key));
...
builder.Services.AddSingleton<ISnsMessenger, SnsMessager>();
